...
Telefone VARCHAR(12),
CONSTRAINT tcli_pk PRIMARY KEY (Matricula_Cliente, Telefone),
...
Telefone VARCHAR(12),
CONSTRAINT telFun_pk PRIMARY KEY (CPF_Funcionario, Telefone),
CONSTRAINT telFun_fk FOREIGN KEY (CPF_Funcionario) REFERENCES FUNCIONARIO (CPF)
);
